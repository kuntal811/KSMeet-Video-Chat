...
<body>
            ...
            <div class="hero">
                ...
                <div class="btn-div">
                    ...
                    <div class="join">
                        ...
                        <button class="btn" id="join-room">Join <span> </span></button>
                    </div>
                </div>
            </div>
            <div class="cover">
    ...
    <div id="meeting">
        <div class="show-msg" id="show-msg">
            <p>Waiting to join someone</p>
            <p>Share the meeting code to join</p>
            <div class="copy-meeting-id">
